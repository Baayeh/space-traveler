...
const Rocket = () => {
  ...
  return (
    <section id="rockets" className="pt-[8rem] pb-10">
      <div className="rocket-list text-white flex justify-center items-center gap-[5rem] flex-wrap">
        {rockets
          && rockets?.map((rocket) => (
            <div
              key={rocket.id}
              className="rocket-card border rounded relative overflow-hidden w-[25rem]"
            >
              ...
              <div className="rocket-img rounded overflow-hidden w-[25rem] h-[15rem]">
                <img
                  src={rocket.flickr_images}
                  alt={rocket.rockets_name}
                  className="w-[25rem] h-[15rem] object-fill"
                />
              </div>
              <div className="rocket-overlay bg-orange-500">
                <div className="rocket-desc p-10 flex flex-col justify-center items-center h-full">
                  <h3 className="uppercase font-bold underline">
                    {rocket.rockets_name}
                  </h3>
                  <p className="mt-1 mb-3 text-center text-sm">
                    {rocket.description}
                  </p>
